...
Proon = (function() {
  ...
  Proon.prototype["delete"] = function(node) {
    var M, curr, e, i, items, j, k, key, l, len1, len2, len3, len4, len5, len6, m, maxLevels, name, nameRx, path, pathRx, q, r, ref, ref1, rel, s, stat, str, subs, u, value, w, y;
    ...
    if (this.storage) {
      ...
      if (name) {
        ...
        for (w = 0, len6 = subs.length; w < len6; w++) {
          k = subs[w];
