...
var Proon, SomeClass, ª, ªA, ªB, ªC, ªD, ªE, ªF, ªN, ªO, ªR, ªS, ªU, ªV, ªX, ªex, ªhas, ªinsert, ªis, ªisU, ªredefine, ªtype, ªuid;
...
Proon = (function() {
  ...
  Proon.prototype.add = function(node) {
    var M, content, curr, e, el, i, id, j, key, len1, len2, len3, len4, len5, len6, len7, len8, m, maxLen, maxLevels, name, nameRx, parent, path, pathRx, q, r, real, ref, ref1, rel, s, stat, str, u, value, w, y, z;
    ...
    if (this.object) {
      curr = this.object;
      for (i = u = 0, len6 = path.length; u < len6; i = ++u) {
        str = path[i];
    ...
    if (this.storage) {
      key = '/';
      for (i = w = 0, len7 = path.length; w < len7; i = ++w) {
        str = path[i];
    ...
    if (this.dom) {
      id = this.root;
      el = this.dom.getElementById(id);
      for (i = z = 0, len8 = path.length; z < len8; i = ++z) {
        str = path[i];
        parent = el;
        id += '_' + str;
        el = this.dom.getElementById(id);
  ...
  Proon.prototype["delete"] = function(node) {
    var M, curr, e, el, i, id, items, j, k, key, l, len1, len2, len3, len4, len5, len6, len7, m, maxLevels, name, nameRx, parent, path, pathRx, pid, q, r, ref, ref1, rel, s, stat, str, subs, u, value, w, y, z;
    ...
    if (this.storage) {
      ...
      if (name) {
        ...
        for (y = 0, len7 = subs.length; y < len7; y++) {
          k = subs[y];
