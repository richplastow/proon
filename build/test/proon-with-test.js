...
(function(ªG) {
/*! Proon 0.0.12 //// MIT Licence //// http://proon.richplastow.com/ */
...
Proon = (function() {
  ...
  Proon.prototype.add = function(node) {
    var M, content, curr, e, i, j, key, len1, len2, len3, len4, len5, len6, m, maxLen, maxLevels, name, nameRx, path, pathRx, q, r, real, ref, ref1, rel, stat, str, u, value, w, y;
  ...
  Proon.prototype._fsSerializer = function(pwd) {
    var M, item, items, j, l, len1, len2, m, ref, stat, sub, subs;
    if (pwd == null) {
      pwd = this.pwd;
    }
