...
(function(ªG) {
/*! Proon 0.0.8 //// MIT Licence //// http://proon.richplastow.com/ */
...
Proon = (function() {
  ...
  Proon.prototype.add = function(node) {
    var M, content, curr, e, i, j, key, len, len1, len2, len3, len4, len5, m, maxLen, maxLevels, name, nameRx, o, path, pathRx, q, r, real, ref, ref1, rel, stat, str, u, v, value;
  ...
  Proon.prototype["delete"] = function(node) {
    var M, curr, e, i, items, j, k, key, l, len, len1, len2, len3, len4, len5, m, maxLevels, name, nameRx, o, path, pathRx, q, r, ref, ref1, rel, stat, str, subs, u, v, value, w;
    ...
    if (this.storage) {
      ...
      if (name) {
        ...
        for (v = 0, len5 = subs.length; v < len5; v++) {
          k = subs[v];
      ...
      while (key) {
        l = key.length;
        for (i = w = 0, ref1 = this.storage.length - 1; 0 <= ref1 ? w <= ref1 : w >= ref1; i = 0 <= ref1 ? ++w : --w) {
